...
static const char col_oceaninc[]        = "#08457e";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_oceaninc,  col_cyan },
};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_r,      spawn,          {.v = translator } },
	{ MODKEY,                       XK_Pause,  spawn,          {.v = suspend } },
	{ MODKEY|ShiftMask,             XK_End,    spawn,          {.v = poweroff } },
	{ MODKEY|ShiftMask,             XK_Home,   spawn,          {.v = reboot } },
